            ...
            <div className="relative z-10 text-center p-6">
                ...
                >
                    ...
                    <span className="text-sm font-medium text-gray-200">
                        Product Analyst &amp; Full-Stack Developer
                    </span>
                </motion.div>
                ...
                >
                    Building intelligent products at the intersection of technology and design, from AI automations to full-scale systems.
                </motion.p>
                ...
                <motion.div
                    ...
                    animate="visible"
                >
                    <a href="#about" className="px-8 py-4 bg-white text-black font-semibold rounded-lg shadow-lg hover:bg-gray-200 transition-colors duration-300 flex items-center gap-2 mx-auto w-fit">
                        Explore My Work
